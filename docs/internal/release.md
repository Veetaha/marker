...
This [`install.sh`](https://raw.githubusercontent.com/rust-marker/marker/v0.2.3/scripts/release/install.sh) script, can be used to automatically download and verify Marker's binaries.
