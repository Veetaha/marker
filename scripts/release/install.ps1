...
# this way seems is more readable, because it refers to the call site of the function where
# the error was written and not to the throw statement itself in the code snippet that is output.
#
...
function New-TemporaryDirectory {
    ...
    Step New-Item -ItemType Directory -Path $path
}
